...
export const MenuList = (props, ref) => {
        ...
        {props.items.map((group, groupIn) => (
          <React.Fragment key={`${group.title}-wrapper`}>
            ...
            {group.commands.map((command, commandIndex) => (
              <DropdownButton
                key={`${command.label}`}
                ref={selectedGroupIndex === groupIn && selectedCommandIndex === commandIndex ? activeItem : null}
                isActive={selectedGroupIndex === groupIn && selectedCommandIndex === commandIndex}
                onClick={createCommandClickHandler(groupIn, commandIndex)}
              >
