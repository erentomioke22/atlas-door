...
export const metadata: Metadata = {
  ...
  title: {
    default: "اطلس در | نمايندگی شيشه سكوريت و خام | فروش و ارائه خدمات انواع شيشه های سكوريت ، كركره برقی ، انواع درب های اتوماتيک  ، نرده های شيشه ای ، پارتيشن های اداری ، حمام شيشه ای و جام بالكن ها ",
  ...
  openGraph: {
    title: "اطلس در | نمايندگی شيشه سكوريت و خام | فروش و ارائه خدمات انواع شيشه های سكوريت ، كركره برقی ، انواع درب های اتوماتيک  ، نرده های شيشه ای ، پارتيشن های اداری ، حمام شيشه ای و جام بالكن ها ",
    description: "نمايندگی شيشه سكوريت و خام - فروش و ارائه خدمات انواع شيشه های سكوريت ، كركره برقی ، انواع درب های اتوماتيک  ، نرده های شيشه ای ، پارتيشن های اداری ، حمام شيشه ای و جام بالكن ها",
    type: "website",
    locale: "fa_IR",
