...
//     const session =  auth()
//     if (!session) {
//       return NextResponse.json({ status: 400, error: 'invalidate request' });
//     }
...
//     const uploadDir = join(process.cwd(), 'public', 'uploads','post-content'); // Corrected to save in a public directory
...
//     return NextResponse.json({ status: 200, message: 'Image upload successful', imageUrl: `/uploads/post-content/${file.name}` });
//   } catch (error) {
