    ...
    <Surface className="p-1" >
      ...
      // onSubmit={handleSubmit}
       className="flex items-center gap-2">
        ...
        <button className='bg-transparent text-sm text-white border-2 border-current  px-2 py-2  rounded-lg  dark:text-black disabled:brightness-75 disabled:cursor-not-allowed'  type="button" aria-label='set link' onClick={handleSubmit} 
        // disabled={!isValidUrl}
        >
          <FaCheck/>
        </button>
