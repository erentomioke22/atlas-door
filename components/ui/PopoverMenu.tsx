...
export const Menu: React.FC<MenuProps> = ({
  ...
  return (
    <Popover.Root onOpenChange={onOpenChange}>
      ...
      {withPortal ? (
        // radix portal root does not take className in types; keep for z-index in DOM
        // @ts-ignore
...
export const Item: React.FC<ItemProps> = ({ label, close = true, icon, iconComponent, disabled, onClick, isActive }) => {
  const className = cn(
  ...
  const ItemComponent = (close ? Popover.Close : 'button') as any
...
type CategoryTitleProps = { children?: React.ReactNode }
