...
const Modal = ({children,title,header,headerStyle,btnStyle,onClose}) => {
...
<>
  ...
  <div className={`fixed inset-0 h-screen transition-opacity  duration-300 ease-in-out z-[99999] ${open ? "backdrop-blur-sm  opacity-100 " : "pointer-events-none invisible backdrop-blur-0 opacity-0 "}`}>
