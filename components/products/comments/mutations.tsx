...
export function useSubmitCommentMutation(productId: string, category: SortCategory) {
...
export function useEditCommentMutation(productId: string, category: SortCategory) {
  const queryClient = useQueryClient();
...
export function useDeleteCommentMutation(productId: string, category: SortCategory) {
  const queryClient = useQueryClient();
  const mutation = useMutation({
