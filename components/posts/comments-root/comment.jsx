...
const Comment = ({content,user,createdAt,userId,id,replies,likes,_count,parent,post,margin,category,scrollToComment,setCurrentCommentId,setMessage,setReplyInfo,name,email}) => {
