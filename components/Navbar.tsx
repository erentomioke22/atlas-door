...
const Navbar = ({session}:{session:Session | null}) => {
  ...
  const items = [
    ...
    { id: "2", 
      name: "شیشه سکوریت",
      href:'/posts/شیشه-سکوریت-چیست؟-مزایا،-کاربردها-و-تفاوت-با-شیشه-معمولی_sm4t8x2fle',
    },
    { id: "3", 
      name: "شیشه لمینت",
      href:'/posts/شیشه-لمینت:-انواع،-مزایا،-معایب-و-کاربردها-در-ساختمان-و-خودرو-|-راهنمای-جامع_alnqvmf910',
    },
    { id: "4", 
      name: "جام بالکن",
    ...
    { id: "9", 
      name: "لیست قیمت",
      href:'/posts/لیست-قیمت-شیشه-سکوریت-و-شیشه-لمینت-|-۱۴۰۴-۲۰۲۵_bow31ja5yq',
    },
  ];
